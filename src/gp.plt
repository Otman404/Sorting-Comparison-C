...
plot "matrix.dat" using 2:xtic(100) title 'Tri Selection O(n^2)' with lines lw 3 smooth bezier, \
     ...
     "matrix.dat" using 5:xtic(100) title 'Tri Par Dénombrement O(n+k)' with lines lw 3 smooth bezier, \
